...
extern void runAsDipendente(MYSQL *conn);
extern void runAsSetSpazi(MYSQL *conn);
extern void runAsAmministrativo(MYSQL *conn);
extern void ricercaDipNome(MYSQL *conn);
extern void ricercaDipCognome(MYSQL *conn);
extern void ricercaDipNomeCognome(MYSQL *conn);
extern void ricercaPostazione(MYSQL *conn);
